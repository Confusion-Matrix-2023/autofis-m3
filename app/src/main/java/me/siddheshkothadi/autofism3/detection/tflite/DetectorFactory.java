package me.siddheshkothadi.autofism3.detection.tflite;
...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        else if (modelFilename.equals("yolov5m_On5000.tflite")) {
        ...
        else if (modelFilename.equals("yolov5s_FinalData.tflite")) {
            labelFilename = "file:///android_asset/fish.txt";
            isQuantized = false;
            inputSize = 640;
            output_width = new int[]{40, 20, 10};
